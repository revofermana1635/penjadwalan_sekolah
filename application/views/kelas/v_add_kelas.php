						...
						<div class="panel-body">
							<div class="row">
								<div class="col-sm-12 col-xs-12">
									<div class="form-wrap">
										<form action="<?php echo base_url()?>index.php/kelas/do_insert" method="POST">
											<div class="form-body">
												<h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account mr-10"></i>Tambah Data Kelas</h6>
												...
												<div class="row">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="kode_kelas" placeholder="K-X-TKJ">
													...
													<div class="col-md-6">
														<div class="form-group">
															...
															<input type="text" class="form-control" name="nama_kelas" placeholder="X TKJ">
